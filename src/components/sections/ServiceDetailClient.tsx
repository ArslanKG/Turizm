...
export default function ServiceDetailClient({ service }: ServiceDetailClientProps) {
  ...
  // Build service data from translations using slug
  const serviceData = {
    title: t(`service.${service.slug}.title`),
    subtitle: t(`service.${service.slug}.subtitle`),
    description: t(`service.${service.slug}.description`),
    detailedDescription: t(`service.${service.slug}.detailed-description`),
    features: [
      t(`service.${service.slug}.feature1`),
      t(`service.${service.slug}.feature2`),
      t(`service.${service.slug}.feature3`),
      t(`service.${service.slug}.feature4`),
      t(`service.${service.slug}.feature5`),
      t(`service.${service.slug}.feature6`)
    ],
    stats: [
      { label: t(`service.${service.slug}.stat1.label`), value: t(`service.${service.slug}.stat1.value`) },
      { label: t(`service.${service.slug}.stat2.label`), value: t(`service.${service.slug}.stat2.value`) },
      { label: t(`service.${service.slug}.stat3.label`), value: t(`service.${service.slug}.stat3.value`) },
      { label: t(`service.${service.slug}.stat4.label`), value: t(`service.${service.slug}.stat4.value`) }
    ]
  };

  const [animatedStats, setAnimatedStats] = useState(serviceData.stats.map(() => '0'));

  // Animate stats on mount
  useEffect(() => {
    const timers = serviceData.stats.map((stat, index) => {
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-4xl font-serif font-bold text-slate-900 mb-12" style={{ fontFamily: 'Playfair Display, serif' }}>
                {t('service-detail.features-title')}
              </h2>
            ...
            <div className="space-y-8">
              <h3 className="text-3xl font-serif font-bold text-slate-900 mb-8" style={{ fontFamily: 'Playfair Display, serif' }}>
                {t('service-detail.why-choose-us')}
              </h3>
                ...
                <div className="p-8 bg-white rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-100">
                  <div className="space-y-6">
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 text-lg" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.experience-title')}</div>
                        <div className="text-sm text-slate-600" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.experience-description')}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 text-lg" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.expert-team-title')}</div>
                        <div className="text-sm text-slate-600" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.expert-team-description')}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 text-lg" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.support-title')}</div>
                        <div className="text-sm text-slate-600" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.support-description')}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 text-lg" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.security-title')}</div>
                        <div className="text-sm text-slate-600" style={{ fontFamily: 'Inter, sans-serif' }}>{t('service-detail.security-description')}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 rounded-3xl shadow-2xl shadow-slate-900/50 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <span>{t('service-detail.get-free-quote')}</span>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link
              ...
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
              <span>{t('service-detail.explore-all-services')}</span>
