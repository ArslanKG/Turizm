      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            ...
            <span className="block text-orange-300">Birlikte Gerçekleştirelim</span>
          </h2>
          
          <div className="w-24 h-1 bg-white mx-auto mb-8"></div>
          
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            500'den fazla başarılı proje deneyimimizle sizin de hayalinizdeki projeyi hayata geçirebiliriz. 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-300 mb-2">50M+</div>
              <div className="text-gray-400">m² İnşaat Alanı</div>
            </div>
          </div>
        </div>
      </div>
